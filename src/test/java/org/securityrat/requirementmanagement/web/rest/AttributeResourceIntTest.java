...
public class AttributeResourceIntTest {
    ...
    public void getAllAttributesByShowOrderIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the attributeList where showOrder greater than or equals to DEFAULT_SHOW_ORDER
        defaultAttributeShouldBeFound("showOrder.greaterOrEqualThan=" + DEFAULT_SHOW_ORDER);

        // Get all the attributeList where showOrder greater than or equals to UPDATED_SHOW_ORDER
        defaultAttributeShouldNotBeFound("showOrder.greaterOrEqualThan=" + UPDATED_SHOW_ORDER);
    }
    ...
    public void getAllAttributesByShowOrderIsLessThanSomething() throws Exception {
        ...
        // Get all the attributeList where showOrder less than or equals to DEFAULT_SHOW_ORDER
        defaultAttributeShouldNotBeFound("showOrder.lessThan=" + DEFAULT_SHOW_ORDER);

        // Get all the attributeList where showOrder less than or equals to UPDATED_SHOW_ORDER
    ...
    public void getAllAttributesByParentIsEqualToSomething() throws Exception {
        // Initialize the database
        Attribute parent = AttributeResourceIntTest.createEntity(em);
        em.persist(parent);
        em.flush();
