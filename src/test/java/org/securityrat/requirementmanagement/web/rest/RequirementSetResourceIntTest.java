...
/**
 * Test class for the RequirementSetResource REST controller.
 *
 * @see RequirementSetResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = RequirementManagementApp.class)
public class RequirementSetResourceIntTest {
    ...
    public void getAllRequirementSetsByShowOrderIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the requirementSetList where showOrder greater than or equals to DEFAULT_SHOW_ORDER
        defaultRequirementSetShouldBeFound("showOrder.greaterOrEqualThan=" + DEFAULT_SHOW_ORDER);

        // Get all the requirementSetList where showOrder greater than or equals to UPDATED_SHOW_ORDER
        defaultRequirementSetShouldNotBeFound("showOrder.greaterOrEqualThan=" + UPDATED_SHOW_ORDER);
    }
    ...
    public void getAllRequirementSetsByShowOrderIsLessThanSomething() throws Exception {
        ...
        // Get all the requirementSetList where showOrder less than or equals to DEFAULT_SHOW_ORDER
        defaultRequirementSetShouldNotBeFound("showOrder.lessThan=" + DEFAULT_SHOW_ORDER);

        // Get all the requirementSetList where showOrder less than or equals to UPDATED_SHOW_ORDER
    ...
    public void getAllRequirementSetsByAttributeKeyIsEqualToSomething() throws Exception {
        // Initialize the database
        AttributeKey attributeKey = AttributeKeyResourceIntTest.createEntity(em);
    ...
    public void updateRequirementSet() throws Exception {
        ...
        RequirementSet updatedRequirementSet = requirementSetRepository.findOne(requirementSet.getId());
    ...
    public void updateNonExistingRequirementSet() throws Exception {
        ...
        // Validate the RequirementSet in the database
        List<RequirementSet> requirementSetList = requirementSetRepository.findAll();
        assertThat(requirementSetList).hasSize(databaseSizeBeforeUpdate + 1);
    }
