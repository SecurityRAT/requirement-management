...
/**
 * Test class for the ExtensionKeyResource REST controller.
 *
 * @see ExtensionKeyResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = RequirementManagementApp.class)
public class ExtensionKeyResourceIntTest {
    ...
    public void getAllExtensionKeysByShowOrderIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the extensionKeyList where showOrder greater than or equals to DEFAULT_SHOW_ORDER
        defaultExtensionKeyShouldBeFound("showOrder.greaterOrEqualThan=" + DEFAULT_SHOW_ORDER);

        // Get all the extensionKeyList where showOrder greater than or equals to UPDATED_SHOW_ORDER
        defaultExtensionKeyShouldNotBeFound("showOrder.greaterOrEqualThan=" + UPDATED_SHOW_ORDER);
    }
    ...
    public void getAllExtensionKeysByShowOrderIsLessThanSomething() throws Exception {
        ...
        // Get all the extensionKeyList where showOrder less than or equals to DEFAULT_SHOW_ORDER
        defaultExtensionKeyShouldNotBeFound("showOrder.lessThan=" + DEFAULT_SHOW_ORDER);

        // Get all the extensionKeyList where showOrder less than or equals to UPDATED_SHOW_ORDER
    ...
    public void updateExtensionKey() throws Exception {
        ...
        ExtensionKey updatedExtensionKey = extensionKeyRepository.findOne(extensionKey.getId());
    ...
    public void updateNonExistingExtensionKey() throws Exception {
        ...
        // Validate the ExtensionKey in the database
        List<ExtensionKey> extensionKeyList = extensionKeyRepository.findAll();
        assertThat(extensionKeyList).hasSize(databaseSizeBeforeUpdate + 1);
    }
